...
/**
 * 200'e yakın “genel amaçlı” starter evren.
 * Bazı ticker’lar Finnhub’da bulunmazsa otomatik skip olur (zarar vermez).
 * İstersen kendi 200’lüğünü buraya yapıştır.
 */
const DEFAULT_UNIVERSE: string[] = [
  ...
  "IBM","ACN","ADP","PANW","CRWD","FTNT","ZS","DDOG","MDB","NET","TEAM","SNOW","OKTA","DOCU","SQ","ABNB","BKNG",
  "EXPE","ROKU","SPOT","DIS","WBD","PARA","CMCSA","TMUS","VZ","T","CSX","UNP","DAL","UAL","AAL","LUV","NKE","COST",
  "WMT","TGT","HD","LOW","SBUX","MCD","KO","PEP","PG","CL","KMB","JNJ","PFE","MRK","ABBV","BMY","LLY","AMGN","GILD",
  "REGN","ISRG","VRTX","BIIB","MDT","TMO","DHR","ABT","SYK","BSX","CVS","UNH","HUM","CI","AET",
  "XOM","CVX","COP","SLB","EOG","OXY","PSX","VLO","MPC","KMI","WFC","JPM","BAC","C","GS","MS","SCHW","BLK","AXP",
  "V","MA","SPGI","ICE","CME","AON","MMC","PGR","TRV","ALL","MET","PRU","CB","BRK.B",
  "BA","LMT","NOC","RTX","GD","HON","GE","CAT","DE","MMM","ETN","EMR","PH","ITW","ROK","CSGP","CTAS",
  "GFS","ARM","SMCI","MRVL","ADI","NXPI","ON","STM","TSM","SHOP","SE","MELI","BIDU","JD","PDD","BABA","NTES","TCEHY",
  "PYPL","SQ","SOFI","HOOD","RIVN","LCID","F","GM","TSM","ASAN","TWLO","HUBS","WDAY","ZS","RBLX","U","EA","TTWO",
  "ENPH","SEDG","FSLR","NEE","DUK","SO","D","EXC","AEP","SRE","O","PLD","AMT","CCI","EQIX",
  "GOLD","NEM","FCX","RIO","BHP","VALE","NUE","X","STLD","AA","ALB"
].slice(0, 200);
...
async function fetchSymbolItems(symbol: string): Promise<LeaderItem[]> {
  ...
  const candles = await fetchCandles(symbol, fromUnix, toUnix); // candles 429 olursa retry içerde
